...
public class LambdaExample {
    ...
    public static void main(final String[] args) {
        ...
        Predicate<User> greaterThanFive= new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age>5;
            }
        };
        Comparator<User> sortUserComparatorByName = new Comparator<User>() {
            @Override
            public int compare(User o1, User o2) {
                return o1.name.compareTo(o2.name);
            }
        };
        repository.select(greaterThanFive,sortUserComparatorByName);
        ...
        // TODO With functional interfaces declared
        Comparator<User> greaterThanTen = new Comparator<User>() {
        ...
        repository.select(lessThanTen,greaterThanTen);
        ...
        // TODO With functional interfaces declared
        repository.select(activeUserPredicate,sortUserComparatorByName);
        ...
        // TODO With functional interfaces declared
        Predicate<User> greaterThanEight= new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age>8;
            }
        };
        repository.select(greaterThanEight,sortUserComparatorByName);
